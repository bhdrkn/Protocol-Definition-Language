 ...
 *   <li>{@link org.xtext.senior.project.protocol.Definitions#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Definitions extends EObject
{
   ...
   * @see org.xtext.senior.project.protocol.ProtocolPackage#getDefinitions_Message()
   * @model containment="true"
   * @generated
   */
  Message getMessage();
  ...
  /**
   * Sets the value of the '{@link org.xtext.senior.project.protocol.Definitions#getMessage <em>Message</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
