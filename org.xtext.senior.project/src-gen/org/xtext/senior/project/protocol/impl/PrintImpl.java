 ...
 * <ul>
 *   <li>{@link org.xtext.senior.project.protocol.impl.PrintImpl#getMessage <em>Message</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrintImpl extends OperationImpl implements Print
{
  ...
  {
    return ProtocolPackage.Literals.PRÝNT;
  }
  ...
  public void setMessage(String newMessage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProtocolPackage.PRÝNT__MESSAGE, oldMessage, message));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProtocolPackage.PRÝNT__MESSAGE:
        return getMessage();
    }
