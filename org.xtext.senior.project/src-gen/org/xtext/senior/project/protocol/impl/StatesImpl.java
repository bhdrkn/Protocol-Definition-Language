 ...
 * <ul>
 *   <li>{@link org.xtext.senior.project.protocol.impl.StatesImpl#getStates <em>States</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatesImpl extends MinimalEObjectImpl.Container implements States
{
  ...
  {
    return ProtocolPackage.Literals.STATES;
  }
  ...
  public EList<State> getStates()
  {
    if (states == null)
    {
      states = new EObjectContainmentEList<State>(State.class, this, ProtocolPackage.STATES__STATES);
    }
    return states;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ProtocolPackage.STATES__STATES:
