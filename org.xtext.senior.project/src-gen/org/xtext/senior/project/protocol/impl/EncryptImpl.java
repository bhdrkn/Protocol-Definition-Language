...
public class EncryptImpl extends OperationImpl implements Encrypt
{
  ...
  public Participant getParticipant()
  {
    if (participant != null && participant.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProtocolPackage.ENCRYPT__PARTÝCÝPANT, oldParticipant, participant));
      }
    }
    return participant;
  }
  ...
  public void setParticipant(Participant newParticipant)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ProtocolPackage.ENCRYPT__PARTÝCÝPANT, oldParticipant, participant));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ProtocolPackage.ENCRYPT__MESSAGE:
        return getMessage();
      case ProtocolPackage.ENCRYPT__PARTÝCÝPANT:
