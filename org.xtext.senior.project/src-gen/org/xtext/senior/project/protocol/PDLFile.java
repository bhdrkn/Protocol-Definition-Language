 ...
 *   <li>{@link org.xtext.senior.project.protocol.PDLFile#getTest <em>Test</em>}</li>
 * </ul>
 * </p>
 *
...
public interface PDLFile extends EObject
{
   ...
   * @see #setTest(Test)
   * @see org.xtext.senior.project.protocol.ProtocolPackage#getPDLFile_Test()
   * @model containment="true"
   * @generated
   */
  Test getTest();
  ...
  /**
   * Sets the value of the '{@link org.xtext.senior.project.protocol.PDLFile#getTest <em>Test</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
